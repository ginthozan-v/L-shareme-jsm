        ...
        <div className='m-2'>
                            ...
                            {postedBy?._id === user?.googleId && (
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        deletePin(_id)
                                    }} type='button' className='bg-white p-2 opacity-70 hover:opacity-100 text-black font-bold text-base rounded-3xl hover:shadow-md outline-none'>
                                    <AiTwotoneDelete />
                                </button>
                            )}
                        </div>
            ...
            <Link to={`user-profile/${ postedBy?._id }`} className='flex gap-2 mt-2 items-center'>
                <img
                    ...
                    src={postedBy?.image} alt="posted by" />
